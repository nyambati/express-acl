...
function whenGlobAndActionAllow(res, next, method, methods) {
...
function whenGlobAndActionDeny(res, next, method, methods) {
...
function whenResourceAndMethodGlob(res, next, action) {
...
function whenIsArrayMethod(res, next, action, method, methods) {
