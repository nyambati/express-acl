...
(function() {
  ...
  module.exports = {
    ...
    authorize: function(req, res, next) {
      ...
      var role = (req.decoded) ? req.decoded.role : undefined || (req.session) ? req.session.role : undefined;
      var resource;
      ...
      if (policy.permissions.length === 1 && policy.permissions[0].resource === '*' && policy.action === 'allow') {
        /*
      ...
      if (policy.permissions.length === 1 && policy.permissions[0].resource === '*' && policy.action === 'deny') {
        /*
         * Allow traffic to all  resources
         * 1. Check for methods
         * 2. If its a string and a glob '*'
      ...
      if (policy.permissions.length >= 1 && policy.permissions[0].resource !== "*") {
